import { defineComponent, resolveComponent, openBlock, createElementBlock, createElementVNode, normalizeClass, withModifiers, toDisplayString, Fragment, renderList, createBlock, createCommentVNode, normalizeStyle, renderSlot, ref, onMounted, createVNode, withCtx } from "vue";
...
const _hoisted_1$2 = { class: "ListItemComponent" };
const _hoisted_2$2 = ["onContextmenu"];
const _hoisted_3$2 = {
  key: 0,
  class: "flex-box"
};
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign(__default__$2, {
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      const _component_ListItemComponent = resolveComponent("ListItemComponent");
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createElementVNode("div", {
          class: normalizeClass(["child-node", {
            hasChild: __props.itemData.children && __props.itemData.children.length,
            hasParent: __props.itemData.parentId
          }]),
          onContextmenu: withModifiers(_ContextMenu, ["stop"])
        }, [
          createElementVNode("div", null, toDisplayString(__props.itemData.name), 1)
        ], 42, _hoisted_2$2),
        __props.itemData.children && __props.itemData.children.length ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.itemData.children, (item, index) => {
            return openBlock(), createBlock(_component_ListItemComponent, {
              onHandleContextMenu: childHandleContextMenu,
              key: index,
              itemData: item
            }, null, 8, ["itemData"]);
          }), 128))
...
const _hoisted_1$1 = { class: "dialog-box" };
const _hoisted_2$1 = { class: "dialog-title" };
const _hoisted_3$1 = { class: "dialog-content" };
    ...
    return (_ctx, _cache) => {
      return __props.show ? (openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_1$1, [
          createElementVNode("div", _hoisted_2$1, toDisplayString(__props.title), 1),
...
var Dialog = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1078cce5"]]);
...
const _hoisted_3 = /* @__PURE__ */ createElementVNode("div", null, "\u8BF7\u8F93\u5165\u5185\u5BB9", -1);
const __default__ = {
  name: "Topology"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          id: "areaId",
          class: "area-box",
          onContextmenu: _cache[0] || (_cache[0] = (e) => {
            e.preventDefault();
          })
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(dataList.value, (item, index) => {
        ...
        createElementVNode("div", {
          class: "menu-box",
          id: "menuPage",
          onClick: withModifiers(clickBtnMask, ["self"])
        }, [
          createElementVNode("div", _hoisted_2, [
            !currentObj.value.parentId ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: "btn",
              onClick: addSuperNode
            }, " \u6DFB\u52A0\u4E0A\u4E00\u7EA7 ")) : createCommentVNode("", true),
            createElementVNode("div", {
              class: "btn",
...
const TOPOLOGY = {
  install(App) {
    components.forEach((item) => {
      App.component(item.name, _sfc_main);
    });
  }
};
export { _sfc_main as Topology, TOPOLOGY as default };
